...
public class CategoryRestExceptionHandler {
	...
	@ExceptionHandler
	public ResponseEntity<CategoryErrorResponse> handleException(CategoryDeleteNotValidException e)
	{
	...
	@ExceptionHandler
	public ResponseEntity<CategoryErrorResponse> productNotFoundException(ProductNotAvailableException e)
	{
		CategoryErrorResponse error = new CategoryErrorResponse();
		error.setStatus(HttpStatus.BAD_REQUEST.value());
		error.setMessage(e.getMessage());
